...
# p节点IP
P_IP=('61.47.19.68' '61.47.19.67' '61.47.19.66' '61.47.19.75')
# D节点IP D节点首节点IP
...
do
    ...
    then
        ...
        --mem-fraction-static 0.85 --max-running-requests 384 --attention-backend ascend --device npu --quantization modelslim \
        --served-model-name glm-5 --moe-a2a-backend deepep --deepep-mode low_latency \
        --cuda-graph-max-bs 12 --disaggregation-transfer-backend ascend --watchdog-timeout 9000 --context-length 180000 \
